 ...
 * 窗口 > 首选项 > Java > 代码生成 > 代码和注释
 */
public class Account_stockInf //访问个人持股
{
	...
	public static int the_date_fun(int accid)//返回买的时间
	{
	...
	public static int the_time_fun(int accid)  //返回买的日期，
	{
		DB2Connection conn  =DoConnection.getCon();
	...
	public static int accsto_fun(int accid)   //返回股票id
		{
	...
	public static float price_fun(int accid)//返回买入价格
		{
			DB2Connection conn  =DoConnection.getCon();
	...
	public static int accnum_fun(int accid)  //返回买的数量
		{
			DB2Connection conn  =DoConnection.getCon();
