  ...
  <table width="756" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="538" valign="top"><form id="form1" name="form1" method="post" action="">
        <p align="left">持有股票：          
          <textarea name="textfield2" rows="2"></textarea>
        </p>
        <p>
          <label></label>
        </p>
        ...
        <label>
        <div align="left">股票代码：
          <input name="selectcontent" type="text" id="selectcontent" />
          <br />
          卖出价格：
          <input name="accprice" type="text" id="accprice" />
          <br />
          卖出数量：
          ...
          <br />
            ...
            <p>
              <label>
              <input type="submit" name="Submit" value="委托" />
              </label>
              <label>
