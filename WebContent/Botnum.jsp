<html>
<head>
<title>管理员界面--修改机器人数量</title>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
</head>
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<!-- ImageReady Slices (页面2.psd) -->
<table width="800" height="996" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
	<tr>
		<td colspan="3">
			<a href="index.jsp" target="_self"><img src="images/test_01.gif" alt="" width="800" height="162" border="0"></a></td>
	</tr>
	<tr>
		<td colspan="3" background="images/test_02.gif"><a href="Admin.jsp">管理员界面</a></td>
	</tr>
	<tr>
		<td width="223" height="58">
		...
		<td width="546" rowspan="7" valign="top" background="images/test_05.gif"><p>&nbsp;</p>
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
	          ...
	          <td width="498" valign="top"><form id="form1" name="form1" method="post" action="">
                  <p>修改机器人数量：
                    <label>
